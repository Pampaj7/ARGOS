...
def load_model(args, device):
    ...
    state = torch.load(args.restore_ckpt, map_location="cpu")
...
def main():
    ...
    parser.add_argument("--restore_ckpt", default="models/iraftstereo_rvc.pth")
    parser.add_argument("--out_dir", default="output_servct_eval_raft_rvc")
