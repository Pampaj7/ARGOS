...
def parse_args():
    parser = argparse.ArgumentParser(description="Extract full SCARED stereo streams.")
...
def main():
    ...
    zips = sorted(list(RAW.glob("dataset_*.zip")) + list(RAW.glob("test_dataset_*.zip")))
    ...
    for zip_path in zips:
        ...
        for member in rgb_members:
            ...
            print(f"Extracting {seq_id} from {zip_path.name}")
