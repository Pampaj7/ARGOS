#!/usr/bin/env python3
"""Benchmark Adaptive Safe-Step Proposal Refiner."""
...
import benchmark_counterfactual_proposal_verifier_refiner as bench
from adaptive_safe_step_proposal_refiner import adaptive_safe_step_proposal_refiner


if __name__ == "__main__":
    bench.counterfactual_proposal_verifier_refiner = adaptive_safe_step_proposal_refiner
