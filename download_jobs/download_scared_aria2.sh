...
INPUT="/home/pampaj/Desktop/stereo/download_jobs/scared_remaining_aria2.txt"
LOG_PREFIX="$(date '+%F %T')"
...
while true; do
  ...
  /home/pampaj/Desktop/stereo/Fast-FoundationStereo/.conda/bin/aria2c \
    --input-file="$INPUT" \
    --continue=true \
  ...
  if ! find /home/pampaj/Desktop/stereo/Fast-FoundationStereo/data/surgical_stereo/scared \
